...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x, mask = None):
        ...
        #now reshaping as we want to perform a mulit head self attention i.e 1536 distributing across 8 heads
...
class MultiHeadCrossAttention(nn.Module):
    ...
    def forward(self, x, y, mask=None):
        batch_size, sequence_length, d_model = x.size() # This is same for both languages 30 x 200 x 512
        print(f"x.size(): {x.size()}")
        kv = self.kv_layer(x) # 30 x 200 x 1024
        print(f"kv.size(): {kv.size()}")
        q = self.q_layer(y) # 30 x 200 x 1512
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, y, decoder_mask):
        ...
        print("================ ADD + NORMALIZATION LAYER 1 ================")
        ...
        print("================ ADD + NORMALIZATION LAYER 2 ================")
        ...
        print("================ ADD + NORMALIZATION LAYER 3 ================")
